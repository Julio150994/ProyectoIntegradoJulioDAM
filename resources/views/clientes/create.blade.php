...
<title>Formulario para añadir clientes</title>
        ...
        <div class="col-md-8 mt-5">
            <div class="card pr-5 pl-4">
                <div class="card-header border-0 bg-white">
                    <h2 class="text-left text-dark mt-4">{{ __('Nuevo cliente') }}</h2>
                </div>
                    ...
                    <form action="{{ route('clientes.store') }}" method="POST">
                        ...
                        <div class="form-group row pt-3 pr-4 pl-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input type="text" placeholder="Apellidos" class="form-control @error('apellidos') is-invalid @enderror" name="apellidos" value="{{ old('apellidos') }}" id="apellidos" required autocomplete="apellidos">
                        ...
                        <div class="form-group row pt-3 pr-4 pl-4">
                            ...
                            <div class="input-group mb-4">
                                ...
                                <input type="text" placeholder="Username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" id="username" required autocomplete="username" autofocus>
